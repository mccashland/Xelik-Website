      ...
      <div className="flex flex-col gap-10  my-4">
        ...
        <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
            The Buyer agrees to pay $99monthly, a payment that will occur for a minimum of 3 months from the effective date, then will continue in perpetuity until the cancellation process has been completed. Cash payment for the Services is due within 30 days of the date of any givenSellers’s invoice. The Services will begin immediately upon the effective date. Missed payments may result in suspension or termination of Services with no refund of pervious payments.
            </span>
          </div>
          <div className="paragraph1">
            <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
            After the minimum 3 months have passed from the effective date, the agreement for app access may be cancelled at any time with 30 days of notice. The notice must be given by email to zainegallagher@xelik.com, and must explicitly state the desire to cancel. If all of this is fulfilled, the cancellation process will be considered completed.
            </span>
          </div>
          <div className="paragraph1">
            <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
          ...
          <div className="space-y-6 py-20 text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            The Sellerswill perform all services required to reasonably ensure the Buyer has access to the Xelik application and its functions.
            </div>
            <div className="py-7 ">
            The Buyer is signing this agreement on the date stated under their signature.
            </div>
...
export default Recuring_App_Access;
