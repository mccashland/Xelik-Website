      ...
      <div className="flex flex-col gap-10  my-4">
        ...
        <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
              The Buyer agrees to pay $129bi-weekly, a payment that will occur
              ...
              completed. Cash payment for the Services is due within 30 days of
              the date of any givenSellers’s invoice. The Services will begin
              immediately upon the effective date. Missed payments may result in
...
export default Recuring_Bi_weekly;
