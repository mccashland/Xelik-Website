    ...
    <div className="flex w-full justify-center   ">
      <div className="flex flex-col gap-10  my-4">       
          ...
          <div className="main dev flex flex-col space-y-8 text-[#ffff] text-[1rem] opacity-[0.7] font-bold w-[90%] sm:w-[80%] m-auto">
            <div>
            __________________________ (“Buyer”), does hereby waive and release, indemnify, and forever discharges Elevate Wellness and Personal Training LLC (“Seller”), and its agents, employees, officers, directors, affiliates, successors, members, independent contractors, and assigns, of and from any and all claims, demands, debts, contracts, expenses, causes of action, lawsuits, damages and liabilities, of every kind and nature, whether known or unknown, in law or equity, that I ever had or may have, arising from or in any way related to the services (“Services”) being provided to me by the Seller provided that this waiver of liability does not apply to any acts of gross negligence, or intentional, willful or wanton misconduct.
            </div>
            <div>
