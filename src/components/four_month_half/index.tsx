      ...
      <div className="flex flex-col gap-10  my-4 text-[#ffffff]">
        ...
        <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph text-base ml-[5px] opacity-[0.7]">
              The Buyer agrees to pay $750 once every two months, a payment that
              will occur for 4 months over the duration of theServices. Cash
              payment for the Services is due within 30 days of the date of any
...
export default Four_month_half;
