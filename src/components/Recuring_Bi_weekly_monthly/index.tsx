    ...
    <div className="flex w-full justify-center   ">
      <div className="flex flex-col gap-10  my-4">
        <div className="main-heading text-[1.5rem] sm:text-[3rem] 2xl:text-[5rem]  p-[3px] flex justify-center items-center text-center text-[#ffffff] font-bold">
          {/* heading start here  */}
          Recurring Bi-Weekly 1-on-1 Coaching Agreement (Monthly)
        </div>
        <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
              The Buyer agrees to pay $249monthly, a payment that will occur for
              a minimum of 4 months from the effective date, then will continue
              in perpetuity until the cancellation process has been completed.
              Cash payment for the Services is due within 30 days of the date of
              any givenSellers’s invoice. The Services will begin immediately
              upon the effective date. Missed payments may result in suspension
              or termination of Services with no refund of pervious payments.
            </span>
          </div>
          <div className="paragraph1">
            <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
              ...
              the agreement for app access may be cancelled at any time with 30
              days of notice. The notice must be given by email to
              zainegallagher@xelik.com, and must explicitly state the desire to
              cancel. If all of this is fulfilled, the cancellation process will
          ...
          <div className="space-y-6 py-20 text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            <div className=" opacity-[0.7]">
              ...
              receive an average of one bi-weekly personal training call that is
...
export default Recuring_Bi_weekly_monthly;
