        ...
        <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-base ml-[5px] opacity-[0.7]">
              ...
              “Services”) in the qufaantities and at the prices stated in clause
              3. The Buyer shall pay all taxes and third-party expenses imposed
              on, in connection with, or measured by the transaction
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph text-base ml-[5px] opacity-[0.7]">
              The Buyer agrees to pay $399monthly, a payment that will occur for
              4 months over the duration of theServices. Cash payment for the
              Services is due within 30 days of the date of any givenSellers’s
              invoice. The Services will begin immediately upon the effective
              date and will end exactly 4 months after the beginning of the
              Services. Missed payments may result in suspension or termination
              of Services with no refund of pervious payments.
            </span>
          </div>
          <div className="paragraph1">
            <span className="span text-[1rem] opacity-100 font-bold">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph text-base ml-[5px] opacity-[0.7]">
              ...
              Buyer is committing to full payment for the 4-monthServices by the
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph text-base ml-[5px] opacity-[0.7]">
              The Sellers shall deliver the Services online. Any goods purchased
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[ff] text-base ml-[5px] opacity-[0.7]">
          ...
          <div className="space-y-6 py-20   text-[1rem] opacity-100 font-bold">
          ...
          <div className="main dev flex flex-col space-y-8   text-[1rem] opacity-[0.7] font-bold">
            <div>
            ...
            <div className="   font-bold text-base ml-[5px] opacity-[0.7]">
...
export default Four_month_monthly;
