...
const Six_month_monthly_Agrement = () => {
  return (
    <div className="flex w-full justify-center   ">
      <div className="flex flex-col gap-10  my-4">
        <div className="main-heading text-[1.5rem] sm:text-[3rem] 2xl:text-[5rem]  p-[3px] flex justify-center items-center text-center text-[#ffffff] font-bold">
          6 Month 1-on-1 Coaching Agreement (Monthly)
        </div>
        <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
          <div className="paragraph text-[#ffffff] text-base ml-[5px] opacity-[0.7] ">
          This Sales Agreement (“Agreement”) for the sale of consulting services is between Elevate Wellness and Personal Training, and _____________________________________ (the “Buyer”).
          </div>
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
            The Buyer agrees to pay $399monthly, a payment that will occur for 6 months over the duration of theServices. Cash payment for the Services is due within 30 days of the date of any givenSellers’s invoice. The Services will begin immediately upon the effective date and will end exactly 6 months after the beginning of the Services. Missed payments may result in suspension or termination of Services with no refund of pervious payments.
            </span>
          </div>
          <div className="paragraph1">
            <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
            The Buyer acknowledges that there is a no cancellation policy. The Buyer is committing to full payment for the 6-monthServices by the end of the 6-month period. 
            </span>
          </div>
          <div className="paragraph1">
            <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
            The Sellers shall deliver the Services online. Any goods purchased through the Sellerswill be providedvia drop shipping and title to and risk of loss of the goods will pass to the Buyer upon such delivery by the Sellers. Any stated delivery dates are approximate. The Sellers will not be liable for any losses, damages, penalties, or expenses for failure to meet any delivery date.
            </span>
          </div>
          <div className="paragraph1">
            <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            ; Due Diligence. The Goods and Services are being sold “as is,” and the Sellers disclaim all warranties of quality, whether express or implied, including the warranties of merchantability and fitness for particular purpose. 
            </span>
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
           No action arising out of or relating to this agreement or the transactions it contemplates may be commenced against the Sellers more than 30 days after the basis for such claim could reasonably have been discovered.
            </span>
          </div>
          <div className="paragraph1">
            <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
            The Sellers will not be liable for delays in performance or for non-performance due to unforeseen circumstances or causes beyond the Sellers’s reasonable control.
            </span>
          </div>
          <div className="paragraph1">
            <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
            The Buyer may not assign any of its rights under this agreement or delegate any performance under this agreement, except with the prior written consent of the Sellers. Any purported assignment of rights or delegation of performance in violation of this section is void.
            </span>
          </div>
          <div className="paragraph1">
            <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
            In any adversarial proceedings between the parties arising out of this agreement or the transactions it contemplates, the sole remedy the Buyer will be entitled to recover from the Sellers is a refund of payment for the Services.
            </span>
          </div>
          <div className="paragraph1">
            <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
          ...
          <div className="space-y-6 py-20 text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            <div className=" opacity-[0.7]">
              ...
              contract. This call may be rescheduled by the Sellers or the Buyer
              with 48 hours of notice or given written consent of the other
              party through email or text message it may be rescheduled at any
              time. Other supplemental services the Sellersmay provide to the
              Buyer to help them reach their wellness goals include; weekly
              custom-made workout plans, habit formation plans, tailored
              nutrition plans including macronutrient and caloric
              ...
              services listed in the Buyer’s tailored plan, and the Buyer wishes
              to add them, the Sellers must provide the Buyer with the
              supplemental service with in a reasonable time upon request.
            </div>
            <div className="py-7 ">
              The Buyer is signing this agreement on the date stated under their
              signature.
            </div>
          ...
          <div className="main dev flex flex-col space-y-8 text-[#ffff] text-[1rem] opacity-[0.7] font-bold">
            <div>
              ...
              in law or equity, that I, the Buyer, ever had or may have, arising
              from or in any way related to the Services being provided to me by
              the Seller provided that this waiver of liability does not apply
              to any acts of gross negligence, or intentional, willful or wanton
              misconduct.
            </div>
            <div>
              The buyer understands that all nutrition recommendations are
              merely recommendations and are not to be taken as medical advice.
              The recommendations are not prescriptions by any doctor or
              dietician. The buyer agrees to waive any liability due to
            ...
            <div>
              ...
              property associated with such Services, including but not limited
              to temporary or permanent damage, unsatisfactory results from said
            ...
            <div>
              ...
              Waiver and Release. I understand and confirm that by signing this
              Waiver and Release, I have given up considerable future legal
              rights. I have signed this Agreement freely, voluntarily, under no
              duress or threat of duress, without inducement, promise or
              guarantee being communicated to me. My signature is proof of my
              intention to execute a complete and unconditional Waiver and
            ...
            <div>
              ...
              diagnose disease. I also acknowledge that I have been warned that
              I should consult a Physician before undergoing any dietary or food
              supplement changes. I also affirmatively state that I have
              disclosed any and all known medical or genetic conditions,
              medications I use, and any significant personal or family medical
              history. Any recommendations that I follow for changes in diet,
              including but not limited to the use of food supplements and
              medications are entirely my choice and my responsibility. I am
            ...
            <div>
              ...
              employees and independent contractors from any liability
              whatsoever to me, my personal representatives, estate, heirs, next
              of kin, and assigns for any and all claims and causes of action
              for loss of or damage to my property and for any and all illness,
              injury or other harm to my person, including my death, that may
              result from or occur during my participation in nutrition and
              fitness counseling, whether caused by the sole or concurrent
              negligence of Elevate Wellness and Personal Training, LLC, its
              members, officers, agents, employees and independent contractors.
            </div>
            <div>
            ...
            <div className=" text-[#ffff] font-bold text-base ml-[5px] opacity-[0.7]">
              ...
              RELEASE OF ALL CLAIMS AND CAUSES OF ACTION FOR MY INJURY OR DEATH
              OR DAMAGE TO MY PROPERTY THAT OCCURS WHILE PARTICIPATING IN
              NUTRITION AND FITNESS COUNSELING AND OR DEATH OF ANY PERSON AND
              DAMAGE TO PROPERTY.
            </div>
            <div>
              <span className="underline flex items-end ">
...
export default Six_month_monthly_Agrement;
