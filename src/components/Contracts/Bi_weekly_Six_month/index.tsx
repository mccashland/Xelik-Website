...
const Bi_weekly_Six_month = ({ userName }: { userName: string }) => {
  return (
    <>
          ...
          <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="main dev flex flex-col space-y-8 text-[#ffff] text-[1rem] opacity-[0.7] font-bold">
              ...
              <div>
                ...
                <div className="py-4">
                  <SubmitButton url="https://www.trainerize.me/checkout/xelik/Team.Xelik?planGUID=c6fb8b900b844f6caabc3b9d0547b262&mode=checkout" />
                </div>
              </div>
            </div>
          </div>
