...
const Recuring_App_Access = () => {
  return (
    <>
        ...
        <div className="flex flex-col gap-10  my-4">
          ...
          <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                The Buyer agrees to pay $99monthly, a payment that will occur
                for a minimum of 3 months from the effective date, then will
            ...
            <div className="space-y-6 py-20 text-[#ffff] text-[1rem] opacity-100 font-bold">
              ...
              <div className=" opacity-[0.7]">
                The Sellerswill perform all services required to reasonably
      ...
      <Link
        href="https://www.trainerize.me/profile/xelik/?planGUID=397455ffe7664155a8b8ca9c6cc33b00&mode=checkout"
        target="_blank"
      >
        Submit
      </Link>
