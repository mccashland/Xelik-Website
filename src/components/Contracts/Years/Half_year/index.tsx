...
const Half_Year = ({ userName,IP }: { userName: string ,IP:any}) => {
        ...
        <div className="flex flex-col gap-10  my-4">
          ...
          <div className="flex flex-col gap-5  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                The Buyer agrees to pay $2,250 bi-annually, a payment that will
                occur twice over the 12 months duration of the Services. Cash
                payment for the Services is due within 30 days of the date of
                any given Sellers’s invoice. The Services will begin immediately
                upon the effective date and will end exactly 12 months after the
                beginning of the Services. Missed payments may result in
                suspension or termination of Services with no refund of
                payments.
              </span>
            </div>
            <div className="paragraph1">
            ...
            <div className="main dev flex flex-col space-y-5 text-[#ffff] text-[1rem] opacity-[0.7] font-bold">
              ...
              <div>
                ...
                <div className="py-4">
                  ...
                  <SubmitButton ref={submitButtonRef} loading={loading} userName={userName}  url="https://www.trainerize.me/checkout/xelik/Team.Xelik?planGUID=bf4d77e5932045c6a51d9527ac5e738f&mode=checkout" onClick={generatePDF} />
                </div>
              </div>
            </div>
          </div>
