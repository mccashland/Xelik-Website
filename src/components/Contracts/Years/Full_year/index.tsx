...
const Full_Year = ({
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push(
          "https://www.trainerize.me/checkout/xelik/Team.Xelik?planGUID=86c3c1ae72f04ab9923430e04b4eeed2&mode=checkout"
        );
      } else {
              ...
              <div>
                ...
                <div className="py-4">
                  <SubmitButton
                    ...
                    loading={loading}
                    userName={userName}
                    url="https://www.trainerize.me/checkout/xelik/Team.Xelik?planGUID=86c3c1ae72f04ab9923430e04b4eeed2&mode=checkout"
                    onClick={generatePDF}
                  />
                </div>
              </div>
