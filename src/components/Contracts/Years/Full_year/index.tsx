...
const Full_Year = ({ userName,IP }: { userName: string ,IP:any}) => {
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("https://www.trainerize.me/checkout/xelik/Team.Xelik?planGUID=86c3c1ae72f04ab9923430e04b4eeed2&mode=checkout")
      } else {
      ...
      <div ref={pdfRef } className="flex w-full justify-center   ">
        <div className="flex flex-col gap-10  my-4">
          ...
          <div className="flex flex-col gap-5  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="space-y-6 py-10 text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            <div className="main dev flex flex-col space-y-5 text-[#ffff] text-[1rem] opacity-[0.7] font-bold">
              ...
              <div>
                ...
                <div className="py-4">
                  <SubmitButton ref={submitButtonRef} loading={loading} userName={userName}  url="https://www.trainerize.me/checkout/xelik/Team.Xelik?planGUID=86c3c1ae72f04ab9923430e04b4eeed2&mode=checkout" onClick={generatePDF} />
                </div>
              </div>
            </div>
          </div>
