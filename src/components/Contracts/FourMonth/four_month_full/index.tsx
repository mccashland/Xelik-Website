...
const Four_month_full = ({
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push(
          "https://www.trainerize.me/profile/xelik/?planGUID=7f3bbd2c16d0407190d2bde53329cd5e&mode=checkout"
        );
      } else {
      ...
      <div ref={pdfRef} className="flex w-full justify-center   ">
        <div className="flex flex-col gap-10  my-4">
          <div className="main-heading text-[1.5rem] sm:text-[3rem] 2xl:text-[5rem]  p-[3px] flex justify-center items-center text-center text-[#ffffff] font-bold">
            {/* heading start here  */}4 Month 1 on 1 Coaching (Full)
          </div>
          <div className="flex flex-col gap-5  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                The Buyer agrees to pay $1,400, a payment that will occur for a
                minimum of 4 months from the effective date, then will continue
                ...
                of any given Sellers’ invoice. The Services will begin 
                immediately upon the effective date. Missed payments may result 
                in suspension or termination of Services with no refund.
              </span>
            </div>
            <div className="paragraph1">
              <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            <div className="paragraph1">
              ...
              <span className="spansemibold text-[#ffff] font-bold text-base ml-[5px] opacity-[0.7] ">
                ...
                the Sellers disclaim all warranties of quality, whether express
