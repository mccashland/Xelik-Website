...
const Four_month_monthly = ({ userName,IP }: { userName: string ,IP:any}) => {
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("https://www.trainerize.me/profile/xelik/?planGUID=938872626f5048018b3f996eb7be58e5&mode=checkout")
      } else {
          ...
          <div className="flex flex-col gap-5  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-base ml-[5px] opacity-[0.7]">
                ...
                “Services”) in the qufaantities and at the prices stated in
                clause 3. The Buyer shall pay all taxes and third-party expenses
            ...
            <div className="space-y-6 py-5   text-[1rem] opacity-100 font-bold">
            ...
            <div className="main dev flex flex-col space-y-5   text-[1rem] opacity-[0.7] font-bold">
              <div>
