...
const FourMonth_BiWeekly = ({ userName,IP }: { userName: string ,IP:any}) => {
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("https://www.trainerize.me/checkout/xelik/Team.Xelik?planGUID=3bfaac4b80f64b59928e7e4453a349c3&mode=checkout")
      } else {
