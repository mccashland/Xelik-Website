...
const Coach_Quarterly = ({ userName }: { userName: string }) => {
  return (
    <>
          ...
          <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                ...
                agreed to pay $297 quarterly over the duration of this Agreement
                to meet the Membership Fee requirement. Payment for the Product
                is due within 30 days of the date of a credit charge or a
                Seller’s invoice. Access to all products and services will begin
                immediately upon the effective date and will continue in
            ...
            <div className="paragraph1">
              <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
                6. Limitation of Liability. The Seller will not be liable for
                any indirect, special, consequential, or punitive damages
                (including lost profits) arising out of or relating to this
                agreement or the transactions it contemplates (whether for
                breach of contract, tort, negligence, or other form of action)
                and irrespective of whether the Seller has been advised of the
                possibility of any such damage. In no event will the Seller’s
                liability exceed the price the Coach paid to the Seller for the
                Product provided by the Seller giving rise to the claim or cause
                of action.
              </span>
            </div>
            <div className="paragraph1">
            ...
            <div className="main dev flex flex-col space-y-8 text-[#ffff] text-[1rem] opacity-[0.7] font-bold">
              ...
              <div>
                ...
                <div className="py-4">
                  <SubmitButton
                    url="https://buy.stripe.com/cN28Alaad9Xy6zudRp"
                    userName={userName}
                  />
                </div>
              </div>
...
export default Coach_Quarterly;
