          ...
          <div className="flex flex-col gap-5  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                ...
                the date of any given Sellers’s invoice. The Services will begin 
                immediately upon the effective date. Missed payments may result in 
                suspension or termination of Services with no refund.
              </span>
            </div>
            <div className="paragraph1">
              <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
...
export default FourMonth_Bi_Weekly_BiWeekly;
