...
const Six_Month_BiWeekly = ({ userName,IP }: { userName: string ,IP:any}) => {
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("https://www.trainerize.me/profile/xelik/?planGUID=56ada657abbd4b3e9ccbd87dba3e8e0e&mode=checkout")
      } else {
