...
const Six_Month_BiWeekly = ({
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push(
          "https://www.trainerize.me/profile/xelik/?planGUID=56ada657abbd4b3e9ccbd87dba3e8e0e&mode=checkout"
        );
      } else {
        ...
        <div className="flex flex-col gap-10  my-4">
          ...
          <div className="flex flex-col gap-5  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                The Buyer agrees to pay $199 biweekly, a payment that will occur 
                for a minimum of 6 months from the effective date, then will 
                ...
                of the date of any given Sellers’ invoice. The Services will 
...
export default Six_Month_BiWeekly;
