...
const Six_month_monthly = ({
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push(
          "https://www.trainerize.me/profile/xelik/?planGUID=295d7c3cb1ef4500a94449a68b2e36f1&mode=checkout"
        );
      } else {
          ...
          <div className="flex flex-col gap-5  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                ...
                the agreement for Services may be cancelled at any time with 30 
...
export default Six_month_monthly;
