...
const Six_month_half = ({
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push(
          "https://www.trainerize.me/profile/xelik/?planGUID=b98bc9cd0a4f48f59b34f94ee1bbabbc&mode=checkout"
        );
      } else {
        ...
        <div className="flex flex-col gap-10  my-4">
          ...
          <div className="flex flex-col gap-5 w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                The Buyer agrees to pay $1,125 quarterly, a payment that will 
                occur for a minimum of 6 months from the effective date, then 
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                ...
                the agreement for Services may be cancelled at any time with one 
                quarter, 90 days, of notice. The notice must be given by email to 
