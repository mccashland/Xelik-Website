...
const Six_month_half = ({ userName,IP }: { userName: string ,IP:any}) => {
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("https://www.trainerize.me/profile/xelik/?planGUID=b98bc9cd0a4f48f59b34f94ee1bbabbc&mode=checkout")
      } else {
          ...
          <div className="flex flex-col gap-5 w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                ...
                occur for 6 months over the duration of the Services. Cash
