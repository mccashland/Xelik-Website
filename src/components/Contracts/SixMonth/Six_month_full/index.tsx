...
const Six_month_full = ({
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push(
          "https://www.trainerize.me/profile/xelik/?planGUID=d4e883c293ca4a9f82aca3aa6a7e5473&mode=checkout"
        );
      } else {
        ...
        <div className="flex flex-col gap-10  my-4">
          ...
          <div className="flex flex-col gap-5  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                The Buyer agrees to pay $2,100, a payment that will occur 
                biannually and will continue in perpetuity until the cancellation 
                process has been completed. Cash payment for the Services is due 
                within 30 days of the date of any given Sellers’s invoice. The 
                Services will begin immediately upon the effective date. Missed 
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                After the minimum 6 months have passed from the effective date, 
                the agreement for Services may be cancelled at any time with a 
                quarter, 90 days, of notice. The notice must be given by email 
                to finance@xelik.com, and must explicitly state the desire to 
