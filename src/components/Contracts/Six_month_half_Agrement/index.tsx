...
const Six_month_half_Agrement = ({ userName }: { userName: string }) => {
  return (
    <>
        ...
        <div className="flex flex-col gap-10  my-4">
          ...
          <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                The Buyer agrees to pay $1,125quarterly, a payment that will
                occur for 6 months over the duration of theServices. Cash
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                ...
                The Buyer is committing to full payment for the 6-month Services
            ...
            <div className="main dev flex flex-col space-y-8 text-[#ffff] text-[1rem] opacity-[0.7] font-bold">
              ...
              <div>
                ...
                <div className="py-4">
                  <SubmitButton url="https://www.trainerize.me/profile/xelik/?planGUID=b98bc9cd0a4f48f59b34f94ee1bbabbc&mode=checkout" />
                </div>
              </div>
            </div>
          </div>
