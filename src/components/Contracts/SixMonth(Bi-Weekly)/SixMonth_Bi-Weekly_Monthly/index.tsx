...
const SixMonth_Bi_Weekly_Monthly = ({
  userName,
  IP,
  email,
}: {
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push(
          "https://www.trainerize.me/profile/xelik/?planGUID=c6fb8b900b844f6caabc3b9d0547b262&mode=checkout"
        );
      } else {
      ...
      <div ref={pdfRef} className="flex w-full justify-center   ">
        <div className="flex flex-col gap-10  my-4">
          <div className="main-heading text-[1.5rem] sm:text-[3rem] 2xl:text-[5rem]  p-[3px] flex justify-center items-center text-center text-[#ffffff] font-bold">
            6 Month Bi-Weekly 1-on-1 Coaching (Monthly)
          </div>
          <div className="flex flex-col gap-5  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                ...
                for a minimum of 6 months, then will continue in perpetuity 
                until the cancellation process has been completed. Cash over 
                the duration of the Services. Cash payment for the Services is 
                due within 30 days of the date of any given Sellers’s invoice. 
            ...
            <div className="paragraph1">
              <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
                7. Disclaimer of Warranty; Due Diligence{" "}
              </span>
...
export default SixMonth_Bi_Weekly_Monthly;
