...
const SixMonth_Bi_Weekly_Monthly = ({ userName,IP }: { userName: string ,IP:any}) => {
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("https://www.trainerize.me/profile/xelik/?planGUID=c6fb8b900b844f6caabc3b9d0547b262&mode=checkout")
      } else {
