...
const Bi_weekly_Six_Month_biWeekly = ({ userName }: { userName: string }) => {
  return (
    <>
        ...
        <div className="flex flex-col gap-10  my-4">
          ...
          <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                The Buyer agrees to pay $209 biweekly, a payment that will occur
            ...
            <div className="main dev flex flex-col space-y-8 text-[#ffff] text-[1rem] opacity-[0.7] font-bold">
              ...
              <div>
                ...
                <div className="py-4">
                  <SubmitButton
                    url="https://www.trainerize.me/checkout/xelik/Team.Xelik?planGUID=a514cf3ed6fd41f89ab4f91d5f1c1cc6&mode=checkout"
                    userName={userName}
                  />
                </div>
              </div>
...
export default Bi_weekly_Six_Month_biWeekly;
