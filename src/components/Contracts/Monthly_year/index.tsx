...
const Monthly_year = ({ userName }: { userName: string }) => {
  return (
    <>
      <div className="flex w-full justify-center   ">
        <div className="flex flex-col gap-10  my-4">
          <div className="main-heading text-[1.5rem] sm:text-[3rem] 2xl:text-[5rem]  p-[3px] flex justify-center items-center text-center text-[#ffffff] font-bold">
            {/* heading start here  */}
            12 Month 1-on-1 Coaching Agreement (Monthly)
          </div>
          <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                ...
                for 12 months over the duration of the Services. Cash payment
                for the Services is due within 30 days of the date of any given
                Sellers’s invoice. The Services will begin immediately upon the
                effective date and will end exactly 12 months after the
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                ...
                Services by the end of the 12-month period.
              </span>
            </div>
            <div className="paragraph1">
              <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            <div className="main dev flex flex-col space-y-8 text-[#ffff] text-[1rem] opacity-[0.7] font-bold">
              ...
              <div className=" text-[#ffff] font-bold text-base ml-[5px] opacity-[0.7]">
                ...
                AND DAMAGE TO PROPERTY.I HAVE CAREFULLY READ THIS AGREEMENT AND UNDERSTAND IT TO BE A RELEASE OF ALL CLAIMS AND CAUSES OF ACTION FOR MY INJURY OR DEATH OR DAMAGE TO MY PROPERTY THAT OCCURS WHILE PARTICIPATING IN NUTRITION AND FITNESS COUNSELING AND OR DEATH OF ANY PERSON AND DAMAGE TO PROPERTY.
              </div>
              <div>
                <span className="underline flex items-end ">
