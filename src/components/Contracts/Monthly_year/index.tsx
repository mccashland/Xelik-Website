          ...
          <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="main dev flex flex-col space-y-8 text-[#ffff] text-[1rem] opacity-[0.7] font-bold">
              ...
              <div className=" text-[#ffff] font-bold text-base ml-[5px] opacity-[0.7]">
                ...
                AND DAMAGE TO PROPERTY.I HAVE CAREFULLY READ THIS AGREEMENT AND
                UNDERSTAND IT TO BE A RELEASE OF ALL CLAIMS AND CAUSES OF ACTION
                FOR MY INJURY OR DEATH OR DAMAGE TO MY PROPERTY THAT OCCURS
                WHILE PARTICIPATING IN NUTRITION AND FITNESS COUNSELING AND OR
