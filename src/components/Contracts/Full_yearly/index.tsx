...
const Full_yearly = ({ userName }: { userName: string }) => {
  return (
    <>
      <div className="flex w-full justify-center   ">
        <div className="flex flex-col gap-10  my-4">
          <div className="main-heading text-[1.5rem] sm:text-[3rem] 2xl:text-[5rem]  p-[3px] flex justify-center items-center text-center text-[#ffffff] font-bold">
            {/* heading start here  */}
            12 Month 1-on-1 Coaching Agreement (Full)
          </div>
          <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                The Buyer agrees to pay $4,200, a payment that will occur
                one-time upfront for the Services. Cash payment for the Services
                ...
                end exactly 12 months after the beginning of the Services.
                Missed payments may result in suspension or termination of
                Services with no refund of payments.
              </span>
            </div>
            <div className="paragraph1">
              <span className="span  text-[#ffff] text-[1rem] opacity-100 font-bold">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                ...
                The Buyer is committing to full payment for the 12-month
                Services.
              </span>
            </div>
            <div className="paragraph1">
