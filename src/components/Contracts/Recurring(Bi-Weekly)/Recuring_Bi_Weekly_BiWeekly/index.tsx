...
const Recuring_Bi_Weekly_BiWeekly = ({ userName,IP }: { userName: string ,IP:any}) => {
  ...
  const generatePDF = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push("https://www.trainerize.me/checkout/xelik/Team.Xelik?planGUID=402ddae43e75465184475b42fc943f10&mode=checkout")
      } else {
        ...
        <div className="flex flex-col gap-10  my-4">
          ...
          <div className="flex flex-col gap-5  w-[90%] sm:w-[80%] m-auto">
            ...
            <div className="paragraph1">
              ...
              <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
                The Buyer agrees to pay $129 bi-weekly, a payment that will
                occur for a minimum of 4 months from the effective date, then
                will continue in perpetuity until the cancellation process has
                been completed. Cash payment for the Services is due within 30
                days of the date of any given Sellers’s invoice. The Services
                will begin immediately upon the effective date. Missed payments
                may result in suspension or termination of Services with no
            ...
            <div className="space-y-5 py-5 text-[#ffff] text-[1rem] opacity-100 font-bold">
              ...
              <div className=" opacity-[0.7]">
                ...
                receive an average of one bi-weekly personal training call that
                is set for at least 30 minutes, throughout the duration of the
                ...
                at any time. Other supplemental services the Sellersmay provide
...
export default Recuring_Bi_Weekly_BiWeekly;
