import ContractInput from "@/components/Contracts/ContractInput";
    ...
    <div className="flex w-full justify-center   ">
      <div className="flex flex-col gap-10  my-4">
        <div className="main-heading text-[1.5rem] sm:text-[3rem] 2xl:text-[5rem]  p-[3px] flex justify-center items-center text-center text-[#ffffff] font-bold">
          {/* heading start here  */}4 Month 1-on-1 Coaching Agreement (Full)
        </div>
        <div className="flex flex-col gap-10  w-[90%] sm:w-[80%] m-auto">
          ...
          <div className="paragraph1">
            ...
            <span className="paragraph  text-[#ffffff] text-base ml-[5px] opacity-[0.7]">
              The Buyer agrees to pay $1,400, a payment that will occur one-time
          ...
          <div className="paragraph1">
            ...
            <span className="spansemibold text-[#ffff] font-bold text-base ml-[5px] opacity-[0.7] ">
              Diligence. The Goods and Services are being sold “as is,” and the
              Sellers disclaim all warranties of quality, whether express or
...
export default Four_month_full;
